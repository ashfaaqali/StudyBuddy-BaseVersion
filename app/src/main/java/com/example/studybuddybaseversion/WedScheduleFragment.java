...
public class WedScheduleFragment extends Fragment {
    ...
    private void DisplaySchedule() {
        ...
        if (sharedPreferences.contains("Wed S_N_1")) {
            String storedValue = sharedPreferences.getString("Wed S_N_1", "");
        ...
        if (sharedPreferences.contains("Wed S_N_2")) {
            String storedValue = sharedPreferences.getString("Wed S_N_2", "");
            if (!storedValue.isEmpty()){
        ...
        if (sharedPreferences.contains("Wed S_N_3")) {
            String storedValue = sharedPreferences.getString("Wed S_N_3", "");
            if (!storedValue.isEmpty()){
        ...
        if (sharedPreferences.contains("Wed S_N_4")) {
            String storedValue = sharedPreferences.getString("Wed S_N_4", "");
            if (!storedValue.isEmpty()){
        ...
        if (sharedPreferences.contains("Wed S_N_5")) {
            String storedValue = sharedPreferences.getString("Wed S_N_5", "");
            if (!storedValue.isEmpty()){
