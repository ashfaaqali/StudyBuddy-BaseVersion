...
//        Card 1 Buttons
    ...
    private void CardView5Attendance() {
        ...
        editor.putFloat("Tue Percentage Count 5", currentPercentage5);
        editor.putInt("Tue Total Count 5", totalClasses5);
        editor.apply();
                ...
                builder.setPositiveButton("Yes",
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                presentCount5++;
                                editor.putInt("Tue Present Count 5", presentCount5);
                                editor.apply();
                ...
                builder.setPositiveButton("Yes",
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                //CODE FOR POSITIVE RESPONSE
                                absentCount5++;
                                editor.putInt("Tue Absent Count 5", absentCount5);
                                editor.apply();
                ...
                builder.setPositiveButton("Yes",
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                //CODE FOR POSITIVE RESPONSE
                                cancelledCount5++;
                                editor.putInt("Tue Cancel Count 5", cancelledCount5);
                                editor.apply();
    ...
    private void CardView4Attendance() {
        ...
        editor.putFloat("Tue Percentage Count 4", currentPercentage4);
        editor.putInt("Tue Total Count 4", totalClasses4);
        editor.apply();
                ...
                builder.setPositiveButton("Yes",
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                //CODE FOR POSITIVE RESPONSE
                                presentCount4++;
                                editor.putInt("Tue Present Count 4", presentCount4);
                                editor.apply();
                ...
                builder.setPositiveButton("Yes",
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                //CODE FOR POSITIVE RESPONSE
                                absentCount4++;
                                editor.putInt("Tue Absent Count 4", absentCount4);
                                editor.apply();
                ...
                builder.setPositiveButton("Yes",
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                //CODE FOR POSITIVE RESPONSE
                                cancelledCount4++;
                                editor.putInt("Tue Cancel Count 4", cancelledCount4);
                                editor.apply();
    ...
    private void CardView3Attendance() {
        ...
        editor.putFloat("Tue Percentage Count 3", currentPercentage3);
        editor.putInt("Tue Total Count 3", totalClasses3);
        editor.apply();
                ...
                builder.setPositiveButton("Yes",
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                //CODE FOR POSITIVE RESPONSE
                                presentCount3++;
                                editor.putInt("Tue Present Count 3", presentCount3);
                                editor.apply();
                ...
                builder.setPositiveButton("Yes",
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                //CODE FOR POSITIVE RESPONSE
                                absentCount3++;
                                editor.putInt("Tue Absent Count 3", absentCount3);
                                editor.apply();
                ...
                builder.setPositiveButton("Yes",
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                //CODE FOR POSITIVE RESPONSE
                                cancelledCount3++;
                                editor.putInt("Tue Cancel Count 3", cancelledCount3);
                                editor.apply();
    ...
    private void CardView2Attendance() {
        ...
        editor.putFloat("Tue Percentage Count 2", currentPercentage2);
        editor.putInt("Tue Total Count 2", totalClasses2);
        editor.apply();
                ...
                builder.setPositiveButton("Yes",
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                //CODE FOR POSITIVE RESPONSE
                                presentCount2++;
                                editor.putInt("Tue Present Count 2", presentCount2);
                                editor.apply();
                ...
                builder.setPositiveButton("Yes",
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                //CODE FOR POSITIVE RESPONSE
                                absentCount2++;
                                editor.putInt("Tue Absent Count 2", absentCount2);
                                editor.apply();
                ...
                builder.setPositiveButton("Yes",
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                //CODE FOR POSITIVE RESPONSE
                                cancelledCount2++;
                                editor.putInt("Tue Cancel Count 2", cancelledCount2);
                                editor.apply();
    ...
    private void CardView1Attendance() {
        ...
        editor.putFloat("Tue Percentage Count 1", currentPercentage1);
        editor.putInt("Tue Total Count 1", totalClasses1);
        editor.apply();
                ...
                builder.setPositiveButton("Yes",
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                //CODE FOR POSITIVE RESPONSE
                                presentCount1++;
                                editor.putInt("Tue Present Count 1", presentCount1);
                                editor.apply();
                                Toast.makeText(getContext(), "presence recorded in "+s1, Toast.LENGTH_SHORT).show();
                            }
                        });
                ...
                builder.setPositiveButton("Yes",
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                //CODE FOR POSITIVE RESPONSE
                                absentCount1++;
                                editor.putInt("Tue Absent Count 1", absentCount1);
                                editor.apply();
                                Toast.makeText(getContext(), "absence recorded in "+s1, Toast.LENGTH_SHORT).show();
                            }
                        });
                ...
                builder.setPositiveButton("Yes",
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                //CODE FOR POSITIVE RESPONSE
                                cancelledCount1++;
                                editor.putInt("Tue Cancel Count 1", cancelledCount1);
                                editor.apply();
                                Toast.makeText(getContext(), "cancellation recorded in "+s1, Toast.LENGTH_SHORT).show();
                            }
                        });
    ...
    private void DisplaySchedule() {
        ...
        if (sharedPreferences.contains("Tue S_N_1")) {
            s1 = sharedPreferences.getString("Tue S_N_1", "");
            if (!s1.isEmpty()){
                TextView CurrPerInstruction = view.findViewById(R.id.current_percentage_inst);
                CurrPerInstruction.setVisibility(View.VISIBLE);
                SN1 = view.findViewById(R.id.tue_s_name1);
                C1 = view.findViewById(R.id.cv1);
                C1.setVisibility(View.VISIBLE);
                SN1.setText(s1);
                ClassTime1 = view.findViewById(R.id.class_time1);
                String time = sharedPreferences.getString("TueClassTime1", "");
                ClassTime1.setText(time);

                totalClasses1 = sharedPreferences.getInt("Tue Total Count 1", 0);
                TotalClasses1.setText(String.valueOf(totalClasses1));
                presentCount1 = sharedPreferences.getInt("Tue Present Count 1", 0);
                PresentClasses1.setText(String.valueOf(presentCount1));
                absentCount1 = sharedPreferences.getInt("Tue Absent Count 1", 0);
                AbsentClasses1.setText(String.valueOf(absentCount1));
                cancelledCount1 = sharedPreferences.getInt("Tue Cancel Count 1", 0);
                CancelledClasses1.setText(String.valueOf(cancelledCount1));
                currentPercentage1 = sharedPreferences.getFloat("Tue Percentage Count 1", 0);
                CurrentPercentage1.setText(String.valueOf(currentPercentage1));
            }

        }
        if (sharedPreferences.contains("Tue S_N_2")) {
            s2 = sharedPreferences.getString("Tue S_N_2", "");
            if (!s2.isEmpty()){
                SN2 = view.findViewById(R.id.tue_s_name2);
                C2 = view.findViewById(R.id.cv2);
                C2.setVisibility(View.VISIBLE);
                SN2.setText(s2);
                ClassTime2 = view.findViewById(R.id.class_time2);
                String time = sharedPreferences.getString("TueClassTime2", "");
                ClassTime2.setText(time);

                totalClasses2 = sharedPreferences.getInt("Tue Total Count 2", 0);
                TotalClasses2.setText(String.valueOf(totalClasses2));
                presentCount2 = sharedPreferences.getInt("Tue Present Count 2", 0);
                PresentClasses2.setText(String.valueOf(presentCount2));
                absentCount2 = sharedPreferences.getInt("Tue Absent Count 2", 0);
                AbsentClasses2.setText(String.valueOf(absentCount2));
                cancelledCount2 = sharedPreferences.getInt("Tue Cancel Count 2", 0);
                CancelledClasses2.setText(String.valueOf(cancelledCount2));
                currentPercentage2 = sharedPreferences.getFloat("Tue Percentage Count 2", 0);
                CurrentPercentage2.setText(String.valueOf(currentPercentage2));
            }
        }
        if (sharedPreferences.contains("Tue S_N_3")) {
            s3 = sharedPreferences.getString("Tue S_N_3", "");
            if (!s3.isEmpty()){
                SN3 = view.findViewById(R.id.tue_s_name3);
                C3 = view.findViewById(R.id.cv3);
                C3.setVisibility(View.VISIBLE);
                SN3.setText(s3);
                ClassTime3 = view.findViewById(R.id.class_time3);
                String time = sharedPreferences.getString("TueClassTime3", "");
                ClassTime3.setText(time);

                totalClasses3 = sharedPreferences.getInt("Tue Total Count 2", 0);
                TotalClasses3.setText(String.valueOf(totalClasses3));
                presentCount3 = sharedPreferences.getInt("Tue Present Count 2", 0);
                PresentClasses3.setText(String.valueOf(presentCount3));
                absentCount3 = sharedPreferences.getInt("Tue Absent Count 2", 0);
                AbsentClasses3.setText(String.valueOf(absentCount3));
                cancelledCount3 = sharedPreferences.getInt("Tue Cancel Count 2", 0);
                CancelledClasses3.setText(String.valueOf(cancelledCount3));
                currentPercentage3 = sharedPreferences.getFloat("Tue Percentage Count 2", 0);
                CurrentPercentage3.setText(String.valueOf(currentPercentage3));
            }
        }
        if (sharedPreferences.contains("Tue S_N_4")) {
            s4 = sharedPreferences.getString("Tue S_N_4", "");
            if (!s4.isEmpty()){
                SN4 = view.findViewById(R.id.tue_s_name4);
                C4 = view.findViewById(R.id.cv4);
                C4.setVisibility(View.VISIBLE);
                SN4.setText(s4);
                ClassTime4 = view.findViewById(R.id.class_time4);
                String time = sharedPreferences.getString("TueClassTime4", "");
                ClassTime4.setText(time);

                totalClasses4 = sharedPreferences.getInt("Tue Total Count 4", 0);
                TotalClasses4.setText(String.valueOf(totalClasses4));
                presentCount4 = sharedPreferences.getInt("Tue Present Count 4", 0);
                PresentClasses4.setText(String.valueOf(presentCount4));
                absentCount4 = sharedPreferences.getInt("Tue Absent Count 4", 0);
                AbsentClasses4.setText(String.valueOf(absentCount4));
                cancelledCount4 = sharedPreferences.getInt("Tue Cancel Count 4", 0);
                CancelledClasses4.setText(String.valueOf(cancelledCount4));
                currentPercentage4 = sharedPreferences.getFloat("Tue Percentage Count 4", 0);
                CurrentPercentage4.setText(String.valueOf(currentPercentage4));
            }
        }
        if (sharedPreferences.contains("Tue S_N_5")) {
            s5 = sharedPreferences.getString("Tue S_N_5", "");
            if (!s5.isEmpty()){
                SN5 = view.findViewById(R.id.tue_s_name5);
                C5 = view.findViewById(R.id.cv5);
                C5.setVisibility(View.VISIBLE);
                SN5.setText(s5);
                ClassTime5 = view.findViewById(R.id.class_time5);
                String time = sharedPreferences.getString("TueClassTime5", "");
                ClassTime5.setText(time);

                totalClasses5 = sharedPreferences.getInt("Tue Total Count 5", 0);
                TotalClasses5.setText(String.valueOf(totalClasses5));
                presentCount5 = sharedPreferences.getInt("Tue Present Count 5", 0);
                PresentClasses5.setText(String.valueOf(presentCount5));
                absentCount5 = sharedPreferences.getInt("Tue Absent Count 5", 0);
                AbsentClasses5.setText(String.valueOf(absentCount5));
                cancelledCount5 = sharedPreferences.getInt("Tue Cancel Count 5", 0);
                CancelledClasses5.setText(String.valueOf(cancelledCount5));
                currentPercentage5 = sharedPreferences.getFloat("Tue Percentage Count 5", 0);
